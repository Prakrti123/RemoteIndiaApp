...
import PopServiceStyle from "./PopServiceStyle/PopServiceStyle";
...
class PopService extends Component {
    ...
    render() {
        ...
        const renderContent = () => {
            return (
                <View
                    ...
                    style={PopServiceStyle.content}>

                    <ScrollView
                        contentContainerStyle={PopServiceStyle.popularView}
                        horizontal
                        scrollEnabled
                    ...
                    {Service === 1 ?
                        <FlatList
                            ...
                            showsVerticalScrollIndicator={false}
                            contentContainerStyle={PopServiceStyle.AllService}
        ...
        return (
            <View style={[PopServiceStyle.mainView, {
...
export default connect(mapStateToProps, mapDispatchProps)(PopService);